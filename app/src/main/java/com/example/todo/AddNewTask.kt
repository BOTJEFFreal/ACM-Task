...
class AddNewTask : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvTaskStartTime.setOnClickListener{
            val timeSetListner =
                TimePickerDialog.OnTimeSetListener { timePicker, startHour, startMinute ->
            ...
            TimePickerDialog(this,timeSetListner, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(
        ...
        tvTaskStartDate.setOnClickListener{
            ...
            DatePickerDialog(this,dateSetListner,calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH),calendar.get(
                Calendar.DAY_OF_MONTH)).show()

        }

        btnSave.setOnClickListener {
            val titleText: String = tvTitleTextInput.text.toString().trim()
            val descText: String = tvDescTextInput.text.toString().trim()
