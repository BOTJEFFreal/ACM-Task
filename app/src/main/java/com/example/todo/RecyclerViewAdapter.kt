    ...
    private inner class View1ViewHolder(itemView: View, listener: onItemClickListener) :  RecyclerView.ViewHolder(itemView) {
        ...
        init{
            ...
            btnDelete.setOnClickListener {
                ...
                database.child(list[position].textTitle.toString()).removeValue()
                Log.e("positionD",list[position].textTitle.toString())
...
//                notifyItemRemoved(position)
        ...
        fun bind(data: Data) {
            tvdayDateLayoutRev.isInvisible = data.dayDatevisibilityRev == true
    ...
    private inner class View2ViewHolder(itemView: View, listener: onItemClickListener) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: Data) {
            dayDateLayoutRev.isInvisible = data.dayDatevisibilityRev == true
        }}
